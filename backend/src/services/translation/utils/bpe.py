...
__author__ = "Will Wang <willwangv@gmail.com>"
__version__ = "1.0.0"
...
class BPE(object):
    def __init__(
        self, codes_file, merges=-1, separator="@@", vocab=None, glossaries=None
    ):

        with open(codes_file, "r", encoding="utf8") as codes:

            firstline = next(codes)
            ...
            for i, item in enumerate(self.bpe_codes):
                if len(item) != 2:
                    ...
                    sys.stderr.write(
                        "The line should exist of exactly two subword units, "
